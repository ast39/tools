...
class PlumberSeed extends Seeder
{
    ...
    public function run(): void
    {
        $master = Sphere::create([
            'title' => 'Сантехник',
            'body' => 'Просто заменить смеситель может большинство взрослых, но если требуются более масштабные работы,
            связанные с водоотведением или сантехникой, то лучше вызвать мастера. Специалист проведет работы гораздо оперативнее,
            а вы можете потратить это время на решение своих задач. Среди специалистов «Мастера рядом» опытные профессионалы,
            способные спланировать и провести комплексные работы по водоотведению, монтажу систем «теплый пол» и установке
            радиаторов отопления. Мы работаем в Москве и области.',
        ])->id;
