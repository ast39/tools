...
class ElectricSeed extends Seeder
{
    ...
    public function run(): void
    {
        $master = Sphere::create([
            'title' => 'Электрик',
            'body' => '<p>Услуги электрика в Москве и Московской области пользуются большим спросом. Это объясняется тем, что в
            этих регионах проживает большое количество населения, и многие люди нуждаются в услугах электрика.</p>
            <p>Электрики в Москве и Московской области выполняют различные виды работ. Они могут устанавливать и ремонтировать
            электрические приборы, проводить электромонтажные работы, а также осуществлять диагностику и ремонт электрических систем.</p>
            <p>Качество услуг электрика в Москве и Московской области зависит от квалификации специалиста и его опыта работы.
            Многие электрики в этих регионах имеют большой опыт работы и обладают высокой квалификацией.</p>
            <p>Стоимость услуг электрика может варьироваться в зависимости от объема работы и сложности задачи. Однако в целом
            цены на услуги электрика в Москве и Московской области остаются доступными для большинства населения.</p>
            <p>При выборе электрика для выполнения работ в Москве или Московской области следует обращать внимание на его опыт работы,
            квалификацию и отзывы клиентов. Также важно убедиться, что электрик имеет все необходимые разрешения и лицензии на
            выполнение электромонтажных работ.</p>',
        ])->id;
