...
class HourMasterSeed extends Seeder
{
    ...
    public function run(): void
    {
        $master = Sphere::create([
            'title' => 'Муж на час',
            'body' => '<p>Необходимо собрать мебель, повесить упавшую полочку, поменять лампочку, отремонтировать замок или заменить
            ...
            выполнять и частный мастер, однако, это обойдется гораздо дороже.</p>'
        ])->id;
