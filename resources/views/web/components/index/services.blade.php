                    ...
                    <div class="serviceBox" data-service_click>
                        <div class="serviceBox__front">
                            <div class="serviceBox__content">
                                <div class="serviceBox__title">{{ __($v['head']) }}</div>
                                <div class="serviceBox__text color_gray">{{ __($v['text']) }}</div>
                                
                                <div class="serviceBox__btn">
                                    <div class="serviceBox__price">{{ __('Цена от') }} {{ __($v['price']) }} {{ __('руб.') }}</div>
                                    <a class="btn btn_small btn_dark fancybox-inline" href="#popupOrder" target="_self" data-service_click__btn>{{ __('Вызвать мастера') }} <span class="btn__blick"></span></a>
                                </div>
                            </div>
                            
                            <div class="serviceBox__bg" style="--background-image: url('{{ asset('images/services/plank/'.$v['bg']) }}');"></div> 
                        </div>
                        
                        <div class="serviceBox__back">
                            <div class="serviceBox__content color_white">
                                <div class="serviceBox__title">{{ __($v['head']) }}</div>
                                <div class="serviceBox__text">{{ __($v['text']) }}</div>
                                
                                <div class="serviceBox__btn">
                                    <a href="{{ $v['link'] }}" class="btn btn_small btn_light btn_lightColor2" data-service_click__btn>{{ __('Подробнее') }} <span class="btn__blick"></span></a>
                                </div>
                            </div>
